...
// import 'package:doctor_consultation_app/model.dart';
// import 'package:doctor_consultation_app/wineDetail.dart';
//
// import '../../home.dart';
//
...
// }
//
// class _MyHomePageState extends State<Doctorlist> {
...
//                         children: wineBrands.map((list) {
//                           return _buildCard(list);
//                         }).toList()))
//               ],
//             ),
//           ),
...
//           child: ListView(
//               scrollDirection: Axis.vertical,
//               children: recommendList.map((list) {
//                 return _buildCard(list);
//               }).toList()),
//         ),
//       )
...
//   }
//
//   Widget _buildCard(list) {
//     return Padding(
//         padding: EdgeInsets.all(10.0),
//         child: InkWell(
//             onTap: () {
//               Navigator.of(context).push(MaterialPageRoute(
//                   builder: (context) => WineDetail(wineDetail: list)));
//             },
//             child: Container(
//                 width: 200.0,
//                 decoration: BoxDecoration(
